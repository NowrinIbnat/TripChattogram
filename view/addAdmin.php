...
<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      if ($check == 4) {
          ...
          header('location:../controller/addAdminDone.php');
      }
  }
   ...
   <div class="container-fluid">
    ...
    <div class="row justify-content-center">
      <div class="form_container col-md-4 co-sm-4 col-xs-12">
          ...
          <h1 align = "center" id="reg" ><b>Add Admin</h1>
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST" enctype="multipart/form-data"><br/>
                  ...
                  <input type="submit" name="submit" value="ADD" class="btn btn-outline-success btn-block mt-3 font-weight-bold bg-primary">
