...
<body onload="getAllRestaurantDel()">

    <br><br>

    <!-- Search form -->
    <div class="active-pink-3 active-pink-4 mb-4 col-lg-4 col-lg-offset-4">
        <input class="form-control" type="text" placeholder="Search" name="search" id="search" onkeyup="getRestaurantDel(this.value)">
    </div>
