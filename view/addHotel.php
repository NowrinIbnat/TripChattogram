    ...
    <div class="col-md-5 border-right">
      <div class="p-3 py-5">
        <div class="d-flex justify-content-between align-items-center mb-3">
          <h2 class="text-right">Hotel Information</h2>
        </div>
        <?php echo $sMsg; ?>
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
          <div class="row mt-3">
            <div class="col-md-12"><label class="control-labels">Hotel Name</label><input type="text" name="name" id="name" class="form-control" placeholder="Name" required></div>
            <br><br><br>
            <br><br>

            <label class="col-md-12 control-label">Hotel Decription</label>
            <div class="col-md-12">
